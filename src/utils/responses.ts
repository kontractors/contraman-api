 ...
 */
export const sendResponse = (res: Response, code: number, message: string, data?: never) => {
 ...
 */
export const sendSuccessResponse = (res: Response, message: string, data?: never) => {
 ...
 */
export const sendServerErrorResponse = (res: Response, error: never) => {
 ...
 */
export const sendClientErrorResponse = (res: Response, message: string, error?: never) => {
